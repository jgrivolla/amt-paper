...
% \begin{frame}
%   \frametitle{MechTurk worker annotations are cheap and fast. Are they also good?}
% 	\begin{itemwide}
...
% 	\item General conclusion: the combination of several MechTurk worker annotations is better and cheaper than the annotations of a single expert.
% 	\end{itemwide}
% \end{frame}
...
%% Explain that this is not binary classification, in contrast with previous slide.
...
\end{block}
\begin{block}{Result}
High inter-annotator agreement between MechTurk workers and experts. %% add score.
\end{block}
\end{frame}
