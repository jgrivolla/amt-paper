...
\begin{frame}
  ...
  \begin{center}
    \scalebox{.45}{\includegraphics{pics/1903sweatshopchicago.jpg}}
  \end{center}
\end{frame}
...
\begin{columns}[T]
\begin{column}{5cm}
\scalebox{.5}{\includegraphics{pics/geography.png}}
...
\end{column}
\begin{column}{5cm}
\scalebox{.5}{\includegraphics{pics/demographics.png}}
\end{column}
\end{columns}
\end{frame}
