...
As it was expected, the best HIT2 mapping was found for [-5,-1] to -1, [0] to 0 and [+1,+5] to +1 given that 0 is the 'neutral' position and it separates the positive and negative annotations. Notice that the kappas (0.800 and 0.810) are slightly higher than in HIT1.
...
What is surprising is that the inter-batch interannotation agreement was highly increased from HIT2 to HIT3. This may be explained by the fact that most turkers that performed HIT1, HIT2 and HIT3 sequentially, which allow them to improve the annotation quality. This was not the case of the experts, which were three different people for each HIT. However, this is just a hypothesis and can not be contrasted. 
...
It is worth noticing that the fact of moving from HIT1 to HIT2 and from HIT2 to HIT3 provides more information, reduces annotation time (as shown in previous subsection) and results in a higher annotation quality.
